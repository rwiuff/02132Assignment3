...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
            roundnode/.style={rectangle, rounded corners=3mm, draw=green!60, fill=green!5, very thick, minimum size=8mm},
            squarednode/.style={rectangle, rounded corners=3mm, draw=red!60, fill=red!5, very thick, minimum size=8mm},
        ]
